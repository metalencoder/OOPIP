...
import task1.ElectricalAppliancesExceptions.IncorrectEntityName;
import task1.ElectricalAppliancesExceptions.PowerException;
...
public class HomeControlUnit {
     ...
     * @param roomName
     * @return nothing
     * @throws "IncorrectEntityName" in case room existing
     */
    public void addNewRoom(String roomName) throws IncorrectEntityName {
        if (roomName==null || roomName =="") {
            throw new IncorrectEntityName("Room name can't be empty or null") ;
        }
     ...
     * @return nothing
     */
    public void addNewUnit(String unitName, int unitPower, String roomName ) throws IncorrectEntityName,PowerException{
        if (unitName==null || unitName =="") {
            throw new IncorrectEntityName("Unit Name can't be empty or null") ;
        } else {
            if (unitPower<=0){
